...
def _depth_warping(depth_maps_1, depth_maps_2, img_masks, translation_vectors, rotation_matrices,
    ...
    # intrinsic_matrices_inverse, _ = torch.solve(eye, intrinsic_matrices)   ####edited 
...
class TSDFVolume(object):
    ...
    def get_mesh(self, only_visited=False):
        ...
        verts, faces, norms, vals = measure.marching_cubes(tsdf_vol, level=0, gradient_direction='ascent')
