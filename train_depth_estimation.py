...
# parser.add_argument('--architecture_summary', action='store_true', help='Summarize the model architecture')
    ...
    for cur_epoch in range(epoch, args.num_epoch + 1):
        ...
        tq.close()
        print("before .pt 0000000000000000000000000000\n")
